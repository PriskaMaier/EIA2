...
//            };
    ...
    //wolken
    function drawCloud (/*_i_clouds : I_Clouds*/x : number, y : number) {
        crc.beginPath();
    ...
    //schneeflocken
    function drawSnow (/*_i_snow : I_Snow*/x : number, y : number) : void   {
        crc.beginPath();
    ...
    //skifahrer
    function drawSkier (_i_skier : I_Skiers) : void  {
        //kopf
        crc.beginPath();
