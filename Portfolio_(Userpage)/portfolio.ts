/*
    Aufgabe: Semesteraufgabe - Persönliches Online Portfolio
    Name: Priska Maier
    Matrikel: 256326
    Datum: 19.07.2017
...
namespace Portfolio {
    ...
    var contentoverview : Content [] = [mk1_1, mk1_2, mk1_3, mk1_4, mk1_5, mk1_6, mk1_7, mk1_8, mk1_9, mk1_10, mk1_11, mk1_12, mk1_13,
                                        mk2, eia1, eia2, eia3, mg1, mg2, mg3, mg4, bk1, bk2, bk3, bk4, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12,
                                        p13, p14, p15, p16];
    
    
    function generateContentOverview() : void   {
       
            var node : any = document.getElementById("works");
    ...
    function categoryFilter(category : string) : void    {
            
            for (var i = 0; i < contentoverview.length; i++) {
                
                var node : any = document.getElementById("pic-" + i);
